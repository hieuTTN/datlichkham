...
const AdminReport = ()=>{
    ...
    useEffect(()=>{
        const getReport = async() =>{
            var response = await getMethod('/api/report/admin/all?size='+size+'&sort=id,desc&page='+0);
    ...
    return (
        <>
            <div class="headerpageadmin d-flex justify-content-between align-items-center p-3 bg-light border">
                <strong class="text-left"><i className='fa fa-users'></i> Quản Lý Báo Cáo</strong>
                <div class="search-wrapper d-flex align-items-center">
                    ...
                    <button onClick={locReport} className='btn-search-header'>Lọc</button>
                </div>
            </div>
            <div class="tablediv">
